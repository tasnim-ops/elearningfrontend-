  ...
  return (
    <>
            ...
            <div className="col-sm-4 mb-2">
              <SearchBar
                ...
                onSearchChange={(newSearchTerm) =>
                  handleSearchChange("teacher", newSearchTerm)
                }
              />
            </div>
          </div>
          ...
          <div className="row mt-2">
            ...
            <div className="col-sm-4 mb-2">
              <SearchBar
                ...
                //entities={students}
                onSearchChange={(newSearchTerm) =>
                  handleSearchChange("student", newSearchTerm)
                }
              />
            </div>
          </div>
          ...
          <div className="row mt-2">
            ...
            <div className="col-sm-4 mb-2">
              <SearchBar
                ...
                //entities={categories}
                onSearchChange={(newSearchTerm) =>
                  handleSearchChange("category", newSearchTerm)
                }
              />
            </div>
          </div>
                ...
                {categoryTable.map((categ) => (
                  <tr key={categ.id}>
                    ...
                    <td>
                      <IoMdTrash
                        type="button"
                        onClick={() => handleDelete(categ.id, "category")}
                      />{" "}
                      <HiPencilSquare />
                    </td>
                  </tr>
          ...
          <div className="row mt-2">
            ...
            <div className="col-sm-4 mb-2">
              <SearchBar
                ...
                //entities={courses}
                onSearchChange={(newSearchTerm) =>
                  handleSearchChange("course", newSearchTerm)
                }
              />
            </div>
          </div>
      ...
      >
        ...
        <Modal.Body>
          Are you sure you want to delete this {attribute} ? Doing so will
          result in the deletion of all corresponding activities
